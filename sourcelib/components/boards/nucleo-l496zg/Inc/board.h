...
#define BRD_A0              3                   // ADC ADC123_IN8 Mask
...
#define BRD_A3              1                   // ADC ADC123_IN2
#define BRD_A3_PIN          GPIO_PIN_1
#define BRD_A3_GPIO_PORT    GPIOC
#define __BRD_A3_GPIO_CLK() __GPIOC_CLK_ENABLE()
#define BRD_A3_EXTI_IRQ     EXTI1_IRQn
#define BRD_A3_ADC_CHAN     ADC_CHANNEL_2

#define BRD_A4              4                   // ADC ADC12_IN13 SB147,SB157,SB138,SB143
...
#define BRD_A5              5                  // ADC ADC12_IN14 SB147,SB157,SB138,SB143
...
#define BRD_A6              1                   // ADC12_IN16 ADC_A_IN
...
#define BRD_A6_ADC_CHAN     ADC_CHANNEL_16

#define BRD_A7              2                   // ADC123_IN3 ADC_B_IN#
...
#define BRD_A7_ADC_CHAN     ADC_CHANNEL_3

#define BRD_A8              1                   // ADC12_IN6 ADC_C_IN
#define BRD_A8_PIN          GPIO_PIN_1
#define BRD_A8_GPIO_PORT    GPIOA
#define __BRD_A8_GPIO_CLK() __GPIOA_CLK_ENABLE()
#define BRD_A8_EXTI_IRQ     EXTI1_IRQn
#define BRD_A8_ADC_CHAN     ADC_CHANNEL_6

#define BRD_D0              9                   // USART6 USART_A_RX
#define BRD_D0_PIN          GPIO_PIN_9
#define BRD_D0_GPIO_PORT    GPIOD
#define __BRD_D0_GPIO_CLK() __GPIOD_CLK_ENABLE()
#define BRD_D0_EXTI_IRQ     EXTI9_5_IRQn

#define BRD_D1              8                  // USART6 USART_A_TX
#define BRD_D1_PIN          GPIO_PIN_8
#define BRD_D1_GPIO_PORT    GPIOD
#define __BRD_D1_GPIO_CLK() __GPIOD_CLK_ENABLE()
...
#define BRD_D20             4                  // I2S_3/SPI3 I2S_B_WS
#define BRD_D20_PIN         GPIO_PIN_4
#define BRD_D20_GPIO_PORT   GPIOA
#define __BRD_D20_GPIO_CLK()__GPIOA_CLK_ENABLE()
#define BRD_D20_EXTI_IRQ    EXTI4_IRQn

#define BRD_D21             4                  // I2S_3/SPI3 I2S_B_MCK
#define BRD_D21_PIN         GPIO_PIN_4
#define BRD_D21_GPIO_PORT   GPIOB
#define __BRD_D21_GPIO_CLK()__GPIOB_CLK_ENABLE()
#define BRD_D21_EXTI_IRQ    EXTI4_IRQn
...
#define BRD_D26             2                   // I/O I/O
#define BRD_D26_PIN         GPIO_PIN_2
#define BRD_D26_GPIO_PORT   GPIOA
#define __BRD_D26_GPIO_CLK()__GPIOA_CLK_ENABLE()
#define BRD_D26_EXTI_IRQ    EXTI2_IRQn

#define BRD_D27             10                   // I/O I/O
#define BRD_D27_PIN         GPIO_PIN_10
#define BRD_D27_GPIO_PORT   GPIOB
#define __BRD_D27_GPIO_CLK()__GPIOB_CLK_ENABLE()
#define BRD_D27_EXTI_IRQ    EXTI15_10_IRQn

#define BRD_D28             15                  // I/O I/O
#define BRD_D28_PIN         GPIO_PIN_15
#define BRD_D28_GPIO_PORT   GPIOE
#define __BRD_D28_GPIO_CLK()__GPIOE_CLK_ENABLE()
#define BRD_D28_EXTI_IRQ    EXTI15_10_IRQn

#define BRD_D29             0                  // I/O I/O
#define BRD_D29_PIN         GPIO_PIN_0
#define BRD_D29_GPIO_PORT   GPIOB
#define __BRD_D29_GPIO_CLK()__GPIOB_CLK_ENABLE()
#define BRD_D29_EXTI_IRQ    EXTI0_IRQn

#define BRD_D30             12                  // I/O I/O
#define BRD_D30_PIN         GPIO_PIN_12
#define BRD_D30_GPIO_PORT   GPIOE
#define __BRD_D30_GPIO_CLK()__GPIOE_CLK_ENABLE()
#define BRD_D30_EXTI_IRQ    EXTI15_10_IRQn

#define BRD_D31             14                   // I/O I/O CN9 Pin 10 and CN10 Pin 25 both connect to PE2. Conflict D56
#define BRD_D31_PIN         GPIO_PIN_14
#define BRD_D31_GPIO_PORT   GPIOE
#define __BRD_D31_GPIO_CLK()__GPIOE_CLK_ENABLE()
#define BRD_D31_EXTI_IRQ    EXTI15_10_IRQn
...
#define BRD_D49             3                   // I/O I/O
#define BRD_D49_PIN         GPIO_PIN_3
#define BRD_D49_GPIO_PORT   GPIOF
#define __BRD_D49_GPIO_CLK()__GPIOF_CLK_ENABLE()
#define BRD_D49_EXTI_IRQ    EXTI3_IRQn

#define BRD_D50             5                   // I/O I/O
#define BRD_D50_PIN         GPIO_PIN_5
#define BRD_D50_GPIO_PORT   GPIOF
#define __BRD_D50_GPIO_CLK()__GPIOF_CLK_ENABLE()
#define BRD_D50_EXTI_IRQ    EXTI5_IRQn
...
#define BRD_D71             6                   // I/O I/O JP6 Conflict (ETH RMII_DV)
#define BRD_D71_PIN         GPIO_PIN_6
#define BRD_D71_GPIO_PORT   GPIOB
#define __BRD_D71_GPIO_CLK()__GPIOB_CLK_ENABLE()
#define BRD_D71_EXTI_IRQ    EXTI9_5_IRQn

// #define BRD_D72          2                                 //NC
// #define BRD_D72_PIN      GPIO_PIN_2                             //NC
// #define BRD_D72_GPIO_PORT    GPIOB                       //NC
// #define __BRD_D72_GPIO_CLK()     __GPIOB_CLK_ENABLE()                    //NC
// #define BRD_D72_EXTI_IRQ         EXTI2_IRQn                        //NC
...
#define BRD_GREEN_LED_PIN               GPIO_PIN_7
#define BRD_GREEN_LED_GPIO_PORT         GPIOC
#define __BRD_GREEN_LED_GPIO_CLK()      __GPIOC_CLK_ENABLE()
...
#define BRD_DEBUG_UART						LPUART1_BASE
#define BRD_DEBUG_UART_BAUDRATE				115200
#define __BRD_DEBUG_UART_CLK()				__HAL_RCC_LPUART1_CLK_ENABLE()

#define BRD_DEBUG_UART_TX_AF				GPIO_AF8_LPUART1
#define BRD_DEBUG_UART_TX_PIN				GPIO_PIN_7
#define BRD_DEBUG_UART_TX_GPIO_PORT			GPIOG
#define __BRD_DEBUG_UART_TX_GPIO_CLK()		__HAL_RCC_GPIOG_CLK_ENABLE()

#define BRD_DEBUG_UART_RX_AF				GPIO_AF8_LPUART1
#define BRD_DEBUG_UART_RX_PIN				GPIO_PIN_8
#define BRD_DEBUG_UART_RX_GPIO_PORT			GPIOG
#define __BRD_DEBUG_UART_RX_GPIO_CLK()		__HAL_RCC_GPIOG_CLK_ENABLE()
