...
STARTUP_FILE=startup_stm32l475xx
LINKER_FILE=STM32L475VGTx_FLASH
CPU_MODEL=STM32L475xx
 
###################################################
# LIBRARY SOURCES

BRD_PATH=$(SOURCELIB_ROOT)/components/boards/bl475e-iot01a
...
USBCORE_PATH=$(SOURCELIB_ROOT)/src/hal/STM32_USB_Device_Library/Core
USBCDC_PATH=$(SOURCELIB_ROOT)/src/hal/STM32_USB_Device_Library/Class/CDC
USBHID_PATH=$(SOURCELIB_ROOT)/src/hal/STM32_USB_Device_Library/Class/HID
...
CFLAGS += -DENABLE_DEBUG_UART  #Enable UART for debug printf
endif
